"""Train the dual-wheel humanoid skateboard policy with RSL-RL PPO."""
...
parser.add_argument("--task", type=str, default="Isaac-WheelHumanoid-Skateboard-v0", help="Name of the task.")
parser.add_argument(
...
def _copy_final_checkpoint(log_dir: str, task: str) -> None:
    ...
    if not models:
        print("[WARN] No PPO checkpoint was saved.")
        return
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    ...
    if agent_cfg.resume or agent_cfg.algorithm.class_name == "Distillation":
        if args_cli.checkpoint and os.path.isfile(os.path.expanduser(args_cli.checkpoint)):
    ...
    def _save_and_publish(*args, **kwargs):
        out = _orig_save(*args, **kwargs)
